...
trait_data <- read.csv("/home/kdeville/projects/def-zmigicov/mig_lab/honours_kylie/20250609_weight_traitdata.csv")
...
## Running linear traits first (circularity - weight)
